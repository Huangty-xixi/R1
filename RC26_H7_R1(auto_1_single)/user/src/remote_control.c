...
void REMOTE_ParseData(volatile const uint8_t *remote_buf, Remote_Info_Typedef_New  *rc)
{
  ...
  if (remote_buf[0]== 0x5B && remote_buf[1]==0x5B && remote_buf[8]==0x2B)
  {
	   ...
	   else if (remote_buf[0]== 0x5C && remote_buf[1]==0x5C && remote_buf[8]==0x2C)
	   {
	        rc->frame_head1=remote_buf[0];
	        rc->frame_head2=remote_buf[1];
	        rc->frame_tail =remote_buf[8];
	   ...
	   else if (remote_buf[0]== 0x5D && remote_buf[1]==0x5D && remote_buf[8]==0x2D)
	   {
	        rc->frame_head1=remote_buf[0];
	        rc->frame_head2=remote_buf[1];
	        rc->frame_tail =remote_buf[8];
	       ...
	       if(remote_buf[4]==0x00)
	       {
	           rc->modi_x=2;
	       }
	       else if(remote_buf[4]==0x01)
	       {
	           rc->modi_x=1;
	       }
	       else if(remote_buf[4]==0x10)
	       {
	           rc->modi_x=4;
	       }
	       else if(remote_buf[4]==0x11)
	       {
	           rc->modi_x=3;
	       }
				 else if(remote_buf[4]==0xFF)
	       {
	           rc->modi_x=0;
	       }
