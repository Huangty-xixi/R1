...
/* Definitions for SentTask */
osThreadId_t SentTaskHandle;
const osThreadAttr_t SentTask_attributes = {
  .name = "SentTask",
  .stack_size = 128 * 4,
...
void MX_FREERTOS_Init(void) {
  ...
  CheckTaskHandle = osThreadNew(Check_Task, NULL, &CheckTask_attributes);
...
__weak void Free_Task(void *argument)
{
...
/* USER CODE BEGIN Header_Sent_Task */
/**
* @brief Function implementing the SentTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Sent_Task */
__weak void Sent_Task(void *argument)
{
  /* USER CODE BEGIN Sent_Task */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END Sent_Task */
}

/* USER CODE BEGIN Header_Check_Task */
/**
* @brief Function implementing the CheckTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Check_Task */
__weak void Check_Task(void *argument)
{
  /* USER CODE BEGIN Check_Task */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END Check_Task */
}
