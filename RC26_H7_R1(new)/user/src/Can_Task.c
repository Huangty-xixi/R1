...
{
	if(RCctrl.channel == 0) //ң��ģʽ
{
	if(RCctrl.chassis == 0)//����ģʽ
  {
		 Chassis.Chassis_Calc(&Chassis);
	...
	else if(RCctrl.chassis == 1 && RCctrl.zone == 0)//����ģʽ
  {
		weapon_mode();
  ...
  else//ң������
{
	if(RCctrl.channel == 0)//ң��ģʽ
{
	if(RCctrl.chassis == 1 && RCctrl.zone == 0)//����ģʽ
  {
		Chassis.chassis_mission(&Chassis);
 ...
 if(RCctrl.th_put ==true)   //������KFS�յ�
{
 ...
 if(RCctrl.th_rec !=0||RCctrl.modi_x!=0)  //����ָ���յ�
{
  th_5mode();
